...
// BuildServerConfig builds a public ServerConfig response from the current config.
// This is used both by the REST handler and by realtime event publishers.
func BuildServerConfig(cfg *config.Config) api.ServerConfig {
