...
describe("tweetToOgpData", () => {
    ...
    const result = tweetToOgpData(
      {
        ...
        mediaDetails: [
          { type: "photo", media_url_https: "https://pbs.twimg.com/media/A7EiDWcCYAAZT1D.jpg" },
        ],
      },
    ...
    const result = tweetToOgpData(
      {
        ...
        mediaDetails: [
          { type: "video", media_url_https: "https://pbs.twimg.com/media/video_thumb.jpg" },
        ],
      },
  ...
  it("handles missing user info gracefully", () => {
    const result = tweetToOgpData({ text: "orphan tweet" }, "https://x.com/unknown/status/222");
