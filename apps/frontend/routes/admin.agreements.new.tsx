...
import {
  useAdminCreateAgreementDocument,
  useAdminAgreementDocuments,
} from "@/lib/hooks/use-queries";
import { toast } from "sonner";

export const Route = createFileRoute("/admin/agreements/new")({
...
function NewAgreementPage() {
  ...
  useEffect(() => {
    if (type && language && existingDocs?.items) {
      const maxVersion = existingDocs.items.reduce(
        (max: number, doc: (typeof existingDocs.items)[number]) => {
