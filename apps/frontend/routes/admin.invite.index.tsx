  ...
  return (
    <div>
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          {!invite.disabled && (
                            <DropdownMenuItem
                              onClick={() => setDisableDialog({ open: true, inviteId: invite.id })}
                            >
                              {t("actions.disable")}
                            </DropdownMenuItem>
                          )}
      ...
      <Dialog
        ...
        onOpenChange={(open) => setDisableDialog({ open, inviteId: null })}
      >
        <DialogContent>
          <DialogHeader>
      ...
      <Dialog
        ...
        onOpenChange={(open) => setDeleteDialog({ open, inviteId: null })}
      >
        <DialogContent>
          <DialogHeader>
