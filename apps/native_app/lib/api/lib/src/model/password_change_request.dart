...
abstract class PasswordChangeRequest
    implements Built<PasswordChangeRequest, PasswordChangeRequestBuilder> {
  ...
  factory PasswordChangeRequest(
      [void updates(PasswordChangeRequestBuilder b)]) = _$PasswordChangeRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PasswordChangeRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PasswordChangeRequest> get serializer =>
      _$PasswordChangeRequestSerializer();
}

class _$PasswordChangeRequestSerializer
    implements PrimitiveSerializer<PasswordChangeRequest> {
  @override
