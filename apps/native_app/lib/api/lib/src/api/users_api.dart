...
class UsersApi {
  ...
  Future<Response<void>> meAgreementsPost({
    required AcceptAgreementsRequest acceptAgreementsRequest,
    ...
    try {
      const _type = FullType(AcceptAgreementsRequest);
      _bodyData =
          _serializers.serialize(acceptAgreementsRequest, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> meAvatarPost({
  ...
  ///
  /// Parameters:
  /// * [file] - Banner image file (PNG/JPG/WebP/GIF)
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> meBannerPost({
    required MultipartFile file,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> meProfilePatch({
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(updateProfileRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LoginFinishResponse>> meUsernamePatch({
    required UpdateUsernameRequest updateUsernameRequest,
    String? xStepupToken,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(UpdateUsernameRequest);
      _bodyData =
          _serializers.serialize(updateUsernameRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> usersUsernameGet({
    ...
    final _path = r'/users/{username}'.replaceAll(
        '{' r'username' '}',
  ...
  /// * [mediaType] - Filter posts by attached media type.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserPostsPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserPostsPage>> usersUsernamePostsGet({
    required String username,
    int? limit,
    String? cursor,
    PostMediaFilter? mediaType,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/{username}/posts'.replaceAll(
        '{' r'username' '}',
        encodeQueryParameter(_serializers, username, const FullType(String))
            .toString());
    final _options = Options(
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (mediaType != null)
        r'mediaType': encodeQueryParameter(
            _serializers, mediaType, const FullType(PostMediaFilter)),
    };
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(UserPostsPage),
            ) as UserPostsPage;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
