...
class TimelineApi {
  ...
  /// Parameters:
  /// * [limit]
  /// * [cursor] - Cursor returned by previous call.
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [TimelinePage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TimelinePage>> timelineGet({
    int? limit = 30,
    String? cursor,
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(TimelinePage),
            ) as TimelinePage;
