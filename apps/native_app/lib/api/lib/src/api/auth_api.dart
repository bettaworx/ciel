...
class AuthApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [LoginFinishResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LoginFinishResponse>> authLoginFinishPost({
    required LoginFinishRequest loginFinishRequest,
    ...
    final _path = r'/auth/login/finish';
    ...
    try {
      const _type = FullType(LoginFinishRequest);
      _bodyData =
          _serializers.serialize(loginFinishRequest, specifiedType: _type);
    ...
    LoginFinishResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(LoginFinishResponse),
            ) as LoginFinishResponse;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<LoginFinishResponse>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [LoginStartResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LoginStartResponse>> authLoginStartPost({
    required LoginStartRequest loginStartRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/login/start';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(LoginStartRequest);
      _bodyData =
          _serializers.serialize(loginStartRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    LoginStartResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(LoginStartResponse),
    ...
    return Response<LoginStartResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [xStepupToken] - Short-lived step-up token.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [LoginFinishResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LoginFinishResponse>> authPasswordChangePost({
    required PasswordChangeRequest passwordChangeRequest,
    String? xStepupToken,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/auth/password/change';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xStepupToken != null) r'X-Stepup-Token': xStepupToken,
        ...?headers,
      },
      extra: <String, dynamic>{
        'secure': <Map<String, String>>[
    ...
    try {
      const _type = FullType(PasswordChangeRequest);
      _bodyData =
          _serializers.serialize(passwordChangeRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RefreshResponse>> authRefreshPost({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> authRegisterPost({
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [StepupFinishResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StepupFinishResponse>> authStepupFinishPost({
    required StepupFinishRequest stepupFinishRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/stepup/finish';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(StepupFinishRequest);
      _bodyData =
          _serializers.serialize(stepupFinishRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    StepupFinishResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(StepupFinishResponse),
            ) as StepupFinishResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<StepupFinishResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [StepupStartResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StepupStartResponse>> authStepupStartPost({
    required StepupStartRequest stepupStartRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/stepup/start';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(StepupStartRequest);
      _bodyData =
          _serializers.serialize(stepupStartRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    StepupStartResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(StepupStartResponse),
            ) as StepupStartResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<StepupStartResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
