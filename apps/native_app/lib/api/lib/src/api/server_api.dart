...
class ServerApi {
  ...
  const ServerApi(this._dio, this._serializers);
  ...
  /// Parameters:
  /// * [type]
  /// * [language] - Language preference (defaults to 'en')
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [PublicAgreementContent] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PublicAgreementContent>> agreementsTypeLatestGet({
    ...
    final _path = r'/agreements/{type}/latest'.replaceAll(
        '{' r'type' '}',
        encodeQueryParameter(_serializers, type, const FullType(AgreementType))
            .toString());
    ...
    PublicAgreementContent? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(PublicAgreementContent),
            ) as PublicAgreementContent;
    ...
    return Response<PublicAgreementContent>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [PublicAgreementContent] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PublicAgreementContent>> agreementsTypeVersionGet({
    required AgreementType type,
    ...
    final _path = r'/agreements/{type}/{version}'
        .replaceAll(
            '{' r'type' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AgreementVersions>> getAgreementVersions({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/agreements/current';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ServerConfig] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ServerConfig>> getServerConfig({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
